			  ...
			  <div class="container-fluid">
			    ...
			    <div>
			      <ul class="nav navbar-nav">
			      	<li>
			      		<a href="<?php echo base_url('teclados');?>">Recargar</a>
			      	</li>
			      	<li>
						<?php
			      			if (validation_errors()) {
				      			...
				      			<form class="navbar-form navbar-left" role="search" action="<?php echo base_url('bi_teclado/buscar_inventario');?>" method="post">
