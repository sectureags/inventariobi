<div class="panel panel-primary">
  ...
  <div class="panel-body">
  		...
  		<div class="caption">
			  ...
			  <div class="container-fluid">
			    <div class="navbar-header">
			     		<!--link-->
						<a class="navbar-brand" data-toggle="modal" href="#myModalNuevoDD">Crear nuevo</a>
			      		<!-- Modal -->
						<div id="myModalNuevoDD" class="modal fade" role="dialog">
						  <div id="moduloseg" class="modal-dialog">
						    ...
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						         ...
						         <form id="ModalNuevoDD" class="" role="form" method="post" action="<?php echo base_url('bi_dd/crear');?>">
								  ...
								  <div class="form-group"> 
										...
										<input type="text" class="form-control" name="rpm" id="rpm" required>
								  </div>
								  <div class="form-group"> 
		...
		<table class="table table-bordered">    
				...
				<tbody> 
				<?php foreach ($cargar_dds as $fila) :?> <!--//es tipo un contador que entra a un arreglo y me trae todos los registros hasta que terminen-->
					
					<tr>
					<td> <?php echo $fila->id_dd; ?></td>
					<td> <?php echo $fila->categoria; ?></td>
					<td> <?php	echo $fila->tipo; ?></td>
					<td> <?php	echo $fila->marca; ?></td>
					<td> <?php	echo $fila->modelo; ?></td>
					<td> <?php	echo $fila->rpm; ?></td>
					...
					<td>
						<div class="btn-group" role="group">
						    ...
						    <ul class="dropdown-menu">
						      <li><a data-toggle="modal" data-target="#moModalEditarDD<?php echo $fila->id_dd; ?>">Actualizar</a></li>
						      <li><a data-toggle="modal" data-target="#XmoModalEliminarDD<?php echo $fila->id_dd; ?>">Eliminar</a></li>
						    </ul>
						</div>
												<!-- Modal -->
						<div id="moModalEditarDD<?php echo $fila->id_dd; ?>" class="modal fade" role="dialog">
						  	<div id="moduloseg" class="modal-dialog">
						    ...
						    <!-- Modal content-->
							    <div class="modal-content">
							      	...
							      	<div class="modal-body">
							        	<form id="ModalEditarUser" role="form" action="<?php echo base_url('bi_dd/actualizar');?>" method="post">     
												<div class="form-group">    
												<label for="id_dd">Id</label>       
												<input type="text" class="form-control" id="id_dd" name="id_dd" value="<?php echo $fila->id_dd; ?>" required>
												</div>
												<div class="form-group">       
									  	<label for="categoria">Categoria</label>       
								  ...
								  <div class="form-group"> 
										<label for="rpm">RPM</label>       
										<input type="text" class="form-control" name="rpm" id="rpm" value="<?php echo $fila->rpm; ?>" required>
								  </div>
								  <div class="form-group"> 
										<label for="capacidad">Capacidad</label>       
						...
						<!-- Modal Eliminar -->
						<div id="XmoModalEliminarDD<?php echo $fila->id_dd; ?>" class="modal fade" role="dialog">
						  	<div id="moduloseg" class="modal-dialog">
						    <!-- Modal content-->
							    <div class="modal-content">
							      	<div class="modal-header">
							      	...
							      	<div class="modal-body">				      						
		      							...
		      							<p>ID: <?php echo $fila->id_dd; ?></p>
							      	</div>
							      	<div class="modal-footer">
					                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
					                    <a href="<?php echo base_url('bi_dd/eliminar'); ?>/<?php echo $fila->id_dd; ?>" class="btn btn-danger danger">Sí, eliminar</a>
					                </div>
							    </div>
						  	</div>
						</div>
