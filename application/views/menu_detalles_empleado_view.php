<div class="col-md-3 well">
	<ul class="nav nav-tab">
		<?php foreach ($cargar_empleado_detalles as $fila) :?>
			<li><a href="<?php echo base_url('bi_cpu/cpu_empleado');?>/<?php echo $fila->id_empleado; ?>">Internet</a></li>
			<li><a href="<?php echo base_url('bi_cpu/cpu_empleado');?>/<?php echo $fila->id_empleado; ?>">Carpetas</a></li>
