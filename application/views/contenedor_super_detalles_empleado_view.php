...
<div class="panel panel-info">
    ...
    <div class="col-lg-3">
    	<a class="thumbnail">
          <img src="<?php echo base_url(); ?>/foto_empleado.png" alt="Foto Empĺeado">
        </a>
	</div><!-- col-md-3 -->
    <div class="col-lg-9">
    	  <!-- Nav tabs -->
		  <ul class="nav nav-tabs" role="tablist">
		    <li role="presentation" class="active"><a href="#empl_grals" aria-controls="empl_grals" role="tab" data-toggle="tab">UBICACIÓN</a></li>
		    ...
		    <li role="presentation"><a href="#resguardo" aria-controls="resguardo" role="tab" data-toggle="tab">BIENES INFORMÁTICOS</a></li>
		  </ul>	  
		  <!-- Tab panes -->
		  <div class="well well-sm tab-content">
		    <div role="tabpanel" class="tab-pane active" id="empl_grals">
		    	<?php foreach ($cargar_empleado_detalles as $fila) :?> 
					...
					<p> <b> <?php echo $fila->nombre_completo; ?> </b> 
		    ...
		    <div role="tabpanel" class="tab-pane" id="resguardo">
							...
							<div class='panel panel-default'>
							  <div class='panel-heading'>
							    <h3 class='panel-title'>TECLADOS</h3>
							  </div>
							  <div class='panel-body'>
								<table class="table table-bordered">  
									<thead>       
							...
							<div class='panel panel-default'>
							  <div class='panel-heading'>
							    <h3 class='panel-title'>MOUSES</h3>
							  </div>
							  <div class='panel-body'>
								<table class="table table-bordered">  
									<thead>       
