...
<div class="container"> <!-- Inicio del container --> 
	...
	<div class="row" id="tabla_usuarios">
		<table class="table table-bordered">    
			<caption>Tabla Empleados</caption>    
			<thead>       
				<tr> 
					 <th>Id Interno</th>      
					 <th>Codigo Empleado</th>         
			...
			<tbody> 
				<?php foreach ($cargar_empleados as $fila) :?> <!--//es tipo un contador que entra a un arreglo y me trae todos los registros hasta que terminen-->
					...
					<tr>
					<td> <?php echo $fila->id_interno; ?></td>
					<td> <?php echo $fila->codigo_empleado; ?></td>
					<td> <?php	echo $fila->nombre_completo; ?></td>
					<td> <?php	echo $fila->unidad; ?></td>
					<td> <?php	echo $fila->usuario_de_red; ?></td>
					...
					<td> <?php	echo $fila->area; ?></td>
					<td> <?php	echo $fila->cargo; ?></td>
					<td><a href="" data-toggle="modal" data-target="#miModal<?php echo $fila->id_interno; ?>">Editar</a><b>

						<!-- Modal --> 
						<div class="modal fade" id="miModal<?php echo $fila->id_interno; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">    
							<div class="modal-dialog">       
								<div class="modal-content">          
									<div class="modal-header">             
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true"> × </button> 
										...
										<form role="form" action="<?php echo base_url('empleados/actualizar');?>" method="post">     
											<div class="form-group"> 
											<label for="id_user">Id_Interno</label>       
												<input type="text" class="form-control" name="id_interno" value="<?php echo $fila->id_interno; ?>" readonly>      
												<label for="codigo_empleado">Codigo Empleado</label>       
												<input type="text" class="form-control" name="codigo_empleado" value="<?php echo $fila->codigo_empleado; ?>" readonly>       
												<label for="nombre_completo">Nombre Completo</label>       
												<input type="text" class="form-control" name="nombre_completo" value="<?php echo $fila->nombre_completo; ?>"> 
						...
						| <a href="" data-toggle="modal" data-target="#myModal2<?php echo $fila->id_interno; ?>">Eliminar</a></td>

						<!-- Modal --> 
						<div class="modal fade" id="myModal2<?php echo $fila->id_interno; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">    
							<div class="modal-dialog">       
								<div class="modal-content">          
									<div class="modal-header">             
										<button type="button" class="close"  data-dismiss="modal" aria-hidden="true">&times;</button>             
						 			...
						 			<div class="modal-body">Se borrara todo el regisro de la base de datos con id <?php echo $fila->id_interno; ?>, de manera permanente, 
						 				estas seguro que deseas continuar?</div>      
						    		<div class="modal-footer">           
						      			<button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>        
					...
					<td><a href="" data-toggle="modal">Ver detalles</a></td>
