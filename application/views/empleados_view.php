							        	...
							        	<form id="ModalEmpleadoNuevo" name="ModalEmpleadoNuevo" role="form" action="<?php echo base_url('empleados/crear');?>" method="post">     
											...
											<div class="form-group">       
												...
												<?php $areas = array(
														...
														'DIRECCIÓN CENTROS DE ATENCION AL VISITANTE',
														'DIRECCIÓN DE ASUNTOS JURIDICOS',
														'DIRECCIÓN DE CAPACITACION Y CULTURA TURISTICA',
														'DIRECCIÓN DE DESARROLLO Y PROYECTOS TURISTICOS',
														'DIRECCIÓN DE MERCADOTECNIA Y DIFUSION',
														'DIRECCIÓN DE PLANEACION ESTADISTICA E INFORMATICA',
														'DIRECCIÓN DE PROMOCION Y FOMENTO',
														'DIRECCIÓN PLAZA TRES CENTURIAS',
